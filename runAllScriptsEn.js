...
async function runAllScripts() {
  try {
    ...
    console.log("Running step4_makeContentEn.js...");
    await runScript("step4_makeContentEn.js");

    console.log("Running step5_merged.js...");
    await runScript("step5_merged.js");

    console.log("Running step6_postJsonEn.js...");
    await runScript("step6_postJsonEn.js");
