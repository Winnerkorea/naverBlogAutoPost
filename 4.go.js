...
const USER_ID = ''; // 네이버 아이디 
const USER_PASSWORD = ''; // 네이버 비밀번호 
const BLOG_ID = ''; // 블로그 이름 (블로그 URL에 있습니다)
const CATEGORY_ID = 2; // 포스팅할 카테고리 번호
...
const restaurantCount = Object.values(resultData).filter(item => item.keyword).length;
...
// 이모티콘 리스트
const emoticonUrls = [
  { packCode: "cafe_001", seq: 2, src: "https://storep-phinf.pstatic.net/cafe_001/original_2.gif" },
  { packCode: "cafe_001", seq: 11, src: "https://storep-phinf.pstatic.net/cafe_001/original_11.gif" },
  { packCode: "cafe_001", seq: 1, src: "https://storep-phinf.pstatic.net/cafe_001/original_1.gif" },
  ...
  { packCode: "cafe_001", seq: 7, src: "https://storep-phinf.pstatic.net/cafe_001/original_7.gif" },
  { packCode: "cafe_001", seq: 9, src: "https://storep-phinf.pstatic.net/cafe_001/original_9.gif" },
  { packCode: "cafe_001", seq: 3, src: "https://storep-phinf.pstatic.net/cafe_001/original_3.gif" },
  { packCode: "cafe_002", seq: 14, src: "https://storep-phinf.pstatic.net/cafe_002/original_14.gif" },
  { packCode: "cafe_002", seq: 22, src: "https://storep-phinf.pstatic.net/cafe_002/original_22.gif" },
  { packCode: "cafe_004", seq: 1, src: "https://storep-phinf.pstatic.net/cafe_004/original_1.png" },
  { packCode: "cafe_004", seq: 4, src: "https://storep-phinf.pstatic.net/cafe_004/original_4.png" },
  { packCode: "cafe_004", seq: 7, src: "https://storep-phinf.pstatic.net/cafe_004/original_7.png" },
  { packCode: "cafe_004", seq: 3, src: "https://storep-phinf.pstatic.net/cafe_004/original_3.png" },
  { packCode: "cafe_004", seq: 5, src: "https://storep-phinf.pstatic.net/cafe_004/original_5.png" },
  { packCode: "cafe_004", seq: 6, src: "https://storep-phinf.pstatic.net/cafe_004/original_6.png" },
  { packCode: "cafe_004", seq: 10, src: "https://storep-phinf.pstatic.net/cafe_004/original_10.png" },
  { packCode: "cafe_004", seq: 11, src: "https://storep-phinf.pstatic.net/cafe_004/original_11.png" },
  { packCode: "cafe_004", seq: 13, src: "https://storep-phinf.pstatic.net/cafe_004/original_13.png" },
  { packCode: "cafe_004", seq: 15, src: "https://storep-phinf.pstatic.net/cafe_004/original_15.png" },
  { packCode: "cafe_004", seq: 14, src: "https://storep-phinf.pstatic.net/cafe_004/original_14.png" },
  { packCode: "cafe_004", seq: 16, src: "https://storep-phinf.pstatic.net/cafe_004/original_16.png" },
  { packCode: "cafe_004", seq: 22, src: "https://storep-phinf.pstatic.net/cafe_004/original_22.png" },
  { packCode: "cafe_004", seq: 23, src: "https://storep-phinf.pstatic.net/cafe_004/original_23.png" },
  { packCode: "cafe_004", seq: 21, src: "https://storep-phinf.pstatic.net/cafe_004/original_21.png" },
...
function processContent(content) {
  ...
  $('article.blog-post').children().each((i, element) => {
    if (element.name === 'h1' || element.name === 'h2' || element.name === 'div') {
      if (element.name === 'div') {
...
async function createDocumentModel(uploadedImages, blogId, logNo, title, content) {
  const components = [];
  let imageIndex = 0;
  ...
  const helloContentItem = content.find(item => item.type === 'hello_content');
  ...
  content.forEach((item, index) => {
    if (item.keyword) {  // keyword 값이 있는 경우에만 처리
      // 상호명 추가
      components.push({
        id: uuidv4(),
        layout: "default",
   ...
   // 랜덤으로 이모티콘 선택
const randomEmoticon = emoticonUrls[Math.floor(Math.random() * emoticonUrls.length)];
...
async function main() {
  ...
  while (retryCount < maxRetries) {
    try {
      ...
      // 이미지 파일 목록 확인 및 필터링
      const imageFiles = fs.readdirSync(MAKE_IMG_DIR)
      ...
      // documentModel 생성
      const documentModel = await createDocumentModel(uploadedImages, BLOG_ID, null, title, resultData);
      ...
      if (error.message.includes("ENOENT: no such file or directory") ||
        ...
        console.log("세션이 만료되었거나 유효하지 않습니다. 다시 로그인합니다...");
        await performLogin();
        retryCount++;
